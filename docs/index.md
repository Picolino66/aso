...
- [ADR-0017 — Revisão independente de código](adrs/ADR-0017-revisao-independente-de-codigo.md)
- [ADR-0018 — Kanban fiel: colunas restantes e dependencies/blocked_by](adrs/ADR-0018-kanban-fiel-colunas-e-dependencias.md)
...
- [ADR-0023 — Implantação governada](adrs/ADR-0023-implantacao-governada.md)
